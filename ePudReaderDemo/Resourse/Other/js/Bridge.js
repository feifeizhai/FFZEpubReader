...
function getPositionByLocation(x, y) {
...
var getAnchorOffset = function(target, horizontal) {
    ...
    if (horizontal) {
        return (document.body.clientWidth + elem.offsetLeft * 2) * (Math.floor(elem.offsetTop / window.innerHeight));
    }
    
    return elem.offsetTop;
}

var getoffsetLeft = function(target, horizontal) {
    var elem = document.getElementById(target);
