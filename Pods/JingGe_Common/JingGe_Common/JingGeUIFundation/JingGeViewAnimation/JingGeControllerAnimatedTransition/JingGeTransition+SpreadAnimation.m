//
//  JingGeTransition+SpreadAnimation.m
//  JingGe_Commen
//
...
@implementation JingGeTransition (SpreadAnimation)
- (void)spreadNextWithType:(JingGeTransitionAnimationType)type andTransitonContext:(id<UIViewControllerContextTransitioning>)transitionContext {
    ...
    switch (type) {
        case JingGeTransitionAnimationTypeSpreadFromRight:
            rect0 = CGRectMake(screenWidth, 0, 2, screenHeight);
            break;
        case JingGeTransitionAnimationTypeSpreadFromLeft:
            rect0 = CGRectMake(0, 0, 2, screenHeight);
            break;
        case JingGeTransitionAnimationTypeSpreadFromTop:
