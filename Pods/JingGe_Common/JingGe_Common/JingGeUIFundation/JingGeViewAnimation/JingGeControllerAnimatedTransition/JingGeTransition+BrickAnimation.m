//
//  JingGeTransition+BrickAnimation.m
//  JingGe_Commen
//
...
@implementation JingGeTransition (BrickAnimation)
- (void)brickOpenNextWithType:(JingGeTransitionAnimationType)type andTransitionContext:(id<UIViewControllerContextTransitioning>)transitionContext {
    ...
    switch (type) {
        case JingGeTransitionAnimationTypeBrickOpenHorizontal:
...
- (void)brickCloseNextWithType:(JingGeTransitionAnimationType)type andTransitionContext:(id<UIViewControllerContextTransitioning>)transitionContext{
    ...
    switch (type) {
        case JingGeTransitionAnimationTypeBrickCloseHorizontal:
            rect0 = CGRectMake(0, 0 , screenWidth/2, screenHeight);
            rect1 = CGRectMake(screenWidth/2 , 0 , screenWidth/2, screenHeight);
            break;
