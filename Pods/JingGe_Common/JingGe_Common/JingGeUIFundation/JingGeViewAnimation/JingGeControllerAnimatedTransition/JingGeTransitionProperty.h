...
@interface JingGeTransitionProperty : NSObject
/**
 *  转场动画时间
 *
...
/**
 *  返回上个界面的手势 默认：右滑 ：JingGeGestureTypePanRight
 *  choose type of gesture for back , default : JingGeGestureTypePanRight
 */
