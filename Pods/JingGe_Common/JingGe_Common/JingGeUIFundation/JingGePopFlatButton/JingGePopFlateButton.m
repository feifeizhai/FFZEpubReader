...
#import "JingGeFlatDoubleSegment.h"


@interface JingGePopFlateButton ()
{
    NSMutableDictionary *_tintColors;
}

@property (nonatomic, strong) JingGeFlatDoubleSegment *firstSegment;
@property (nonatomic, strong) JingGeFlatDoubleSegment *secondSegment;
@property (nonatomic, strong) JingGeFlatDoubleSegment *thirdSegment; //Only used for menu button
...
@implementation JingGePopFlateButton
@dynamic linesColor;
...
- (void) commonSetup {
    _firstSegment = [[JingGeFlatDoubleSegment alloc]initWithLength:self.frame.size.width
    ...
    _secondSegment = [[JingGeFlatDoubleSegment alloc]initWithLength:self.frame.size.width
                                                   thickness:self.lineThickness
                                                      radius:self.lineRadius
                                                       color:self.tintColor
                                                initialState:doubleSegmentDefaultState];
    ...
    _thirdSegment = [[JingGeFlatDoubleSegment alloc]initWithLength:self.frame.size.width
                                                  thickness:self.lineThickness
                                                     radius:self.lineRadius
                                                      color:self.tintColor
