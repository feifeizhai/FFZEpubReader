...
@interface JingGeCoverController ()<UIGestureRecognizerDelegate>
...
@implementation JingGeCoverController
            ...
            if (self.openAnimate && self.isPan) {
                ...
                if (self.pendingController) {
                    ...
                    if (self.isLeft) {
                        ...
                        self.pendingController.view.frame = CGRectMake(tempPoint.x - ViewWidth, 0, ViewWidth, ViewHeight);
            ...
            if (self.openAnimate) { // 动画
                ...
                if (self.pendingController) {
                    ...
                    if (self.isLeft) {
                        ...
                        if (self.pendingController.view.frame.origin.x <= -(ViewWidth - ViewWidth*0.1)) {
                        ...
                        if (self.currentController.view.frame.origin.x >= - ViewWidth*0.1) {
...
-(BOOL)gestureRecognizer:(UIGestureRecognizer *)gestureRecognizer shouldReceiveTouch:(UITouch *)touch
{
    ...
    if ([NSStringFromClass([touch.view class]) isEqualToString:@"UITableViewCellContentView"] || [[touch.view.superview.superview class] isSubclassOfClass:[UICollectionView class]]) {
        return NO;
    }
    return YES;
}
    ...
    if (self.pendingController) {
        ...
        if (self.isLeft) { // 左边
            ...
            if (animated) {
                ...
                __weak JingGeCoverController *weakSelf = self;
