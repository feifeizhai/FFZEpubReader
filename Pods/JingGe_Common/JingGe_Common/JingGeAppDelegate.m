...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    JingGeBaseNavigationController *navi = [[JingGeBaseNavigationController alloc]initWithRootViewController:[JingGeAnswerViewController new]];
...
- (void)application:(UIApplication *)app didRegisterForRemoteNotificationsWithDeviceToken:(NSData *)deviceToken
{
    ...
    [JingGeThirdConfig bindDeviceToken:deviceToken];
}
...
- (void)application:(UIApplication *)application didReceiveRemoteNotification:(NSDictionary *)userInfo
{
    ...
    [JingGeThirdConfig handleReceiveRemoteNotification:userInfo];
}
