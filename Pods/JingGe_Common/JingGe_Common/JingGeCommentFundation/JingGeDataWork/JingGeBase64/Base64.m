...
- (NSString *)base64EncodedStringWithWrapWidth:(NSUInteger)wrapWidth
{
    ...
    {
        encoded = [self base64EncodedStringWithOptions:NSDataBase64Encoding64CharacterLineLength|NSDataBase64Encoding76CharacterLineLength|NSDataBase64EncodingEndLineWithCarriageReturn|NSDataBase64EncodingEndLineWithLineFeed];
    }
    else
